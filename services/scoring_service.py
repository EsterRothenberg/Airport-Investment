...
class ScoringService:
    ...
    def calculate_demand_growth_score(
        ...
        return self._weighted_average(
            [
                (passenger_growth_score, 0.60),
                (flight_growth_score, 0.40),
            ]
        )
    ...
    def calculate_capacity_pressure_score(
        ...
        return self._weighted_average(
            [
                (load_factor_score, 0.70),
                (flight_growth_score, 0.30),
            ]
        )
    ...
    def calculate_network_value_score(
        ...
        return self._weighted_average(
            [
                (route_count_score, 0.60),
                (long_haul_score, 0.40),
            ]
        )
    ...
    def analyze(
        ...
        demand_score = self.calculate_demand_growth_score(
            metrics
        )

        capacity_score = self.calculate_capacity_pressure_score(
            metrics
        )
        ...
        network_score = self.calculate_network_value_score(
            metrics
        )
        ...
        missing_data = list(metrics.missing_data)
